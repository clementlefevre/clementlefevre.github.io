...
:-------------------------:|:-------------------------:
![Visitors vs expenditures](/images/capital_report_master_card.png){ width=300px }|![](/images/city_benchmark_room_type.png){width=300px} 
...
:-------------------------:|:-------------------------:
![title 1](/images/city_benchmark_availability_30.png){width=300px} |  ![title2 ](/images/city_benchmark_price.png){width=300px} 
...
:-------------------------:|:-------------------------:
![](/images/listing_history_counts.png){width=300px} |  ![](/images/listing_history_prices.png){width=300px} 

Then, looking at the localisation as of may 2017 :

|  Localization of active offers in Berlin |
|:--:|
|  ![](/images/geo_map_multihosting.png) |
...
|:--:|
|  ![](/images/cities_multihosting_ratio.png){ width=400px } |
...
|:--:|
|  ![](/images/missing_values_listings.png){ width=300px } |
...
|   Listing per hosts |
|:--:|
|![](/images/listings_per_host.png){ width=300px }|
...
:-------------------------:|:-------------------------:
|![Listing per hosts](/images/host_listing_counts_reviews.png){ width=300px }|![Listing per hosts](/images/host_listing_availability_30.png){ width=300px } 
...
|:--:|
|![](/images/group_language_reviews.png){ width=300px }|
...
|:--:|
|![](/images/PCA_reviews.png){ width=400px }|
...
:-------------------------:|:-------------------------:
![](/images/eigen_pic_multihost.png){width=300px} |  ![](/images/eigen_pic_singlehost.png){width=300px} 
...
:-------------------------:|:-------------------------:
![](/images/colors_rainbow_appartments.png){ width=300px }|![](/images/PCA_colors_pictures_appartments.png){width=300px} 
...
|  ${\chi}^2$ best features  |
|:--:|
|![](/images/top_features_chi2.png){ width=500px }|

|  XGBoost best features  |
|:--:|
|![](/images/top_features_xgb.png){ width=500px }|


| XGB best fclass features  |
|:--:|
|![](/images/XGB_features_selection.png){ width=500px }|
...
|:--:|
|  ![](/images/ROC_XGB.png){ width=300px } |
...
|:--:|
|  ![](/images/PCA_all_features.png){ width=300px } |
...
|:--:|
|  ![](/images/XGB_final_Top_features_fscore.png){ width=300px } |
...
![Hokusai : Kajikazawa in Kai province](/images/Hokusai_Kajikazawa_in_Kai_province.jpg){ width=300px } 
