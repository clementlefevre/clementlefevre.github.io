...
|Full appartments availability coming 30 days|
|:--:|
|![title 1](/images/airbnb/city_benchmark_availability_30.png)|

|Full appartments prices|
|:--:|
|![title2 ](/images/airbnb/city_benchmark_price.png)|
...
|Evolution of active listings in Berlin|
|:--:|
|![](/images/airbnb/listing_history_counts.png)|

|Evolution of prices|
|:--:|
|![](/images/airbnb/listing_history_prices.png)|
...
|:--:|
|  ![](/images/airbnb/cities_multihosting_ratio.png) |
...
|:--:|
|  ![](/images/airbnb/missing_values_listings.png) |
...
|   Listing per hosts |
|:--:|
|![](/images/airbnb/listings_per_host.png)|
...
|   Number of reviews per listings rented |
|:--:|
|![Listing per hosts](/images/airbnb/host_listing_counts_reviews.png)|

|  Availability per listings rented |
|:--:|
|![Listing per hosts](/images/airbnb/host_listing_availability_30.png)|
...
|:--:|
|![](/images/airbnb/group_language_reviews.png)|

English is the overwhelming language for reviews, we will focus then on it for the further text analysis.
...
Colors PCA
![](/images/airbnb/PCA_colors_pictures_appartments.png)

Main colors in appartment pictures
![](/images/airbnb/colors_rainbow_appartments.png) 
...
- KBest features selection based on $$ {\chi}^2  $$ and FScore,
...
|*$$ {\chi}^2 best features  $$*|
|:--:|
|![](/images/airbnb/top_features_chi2.png)|

|*XGBoost best features*|
|:--:|
|![](/images/airbnb/top_features_xgb.png)|

|*XGB best fclass features*|
|:--:|
|![](/images/airbnb/XGB_features_selection.png)|
...
|:--:|
|  ![](/images/airbnb/PCA_all_features.png) |
...
|:--:|
|  ![](/images/airbnb/XGB_final_Top_features_fscore.png) |
...
![Hokusai : Kajikazawa in Kai province](/images/airbnb/Hokusai_Kajikazawa_in_Kai_province.jpg) 
